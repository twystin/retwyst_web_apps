angular.module('consoleApp').controller('MenuCategoryController', ['$scope', '$modalInstance', 'category', 'is_new', 'SweetAlert',
    function($scope, $modalInstance, category, is_new, SweetAlert) {
