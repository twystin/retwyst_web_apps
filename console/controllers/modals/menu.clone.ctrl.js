angular.module('consoleApp').controller('MenuCloneController', ['$scope', '$modalInstance', 'menu_id', 'outlet_id', 'SweetAlert', 'consoleRESTSvc',
    function($scope, $modalInstance, menu_id, outlet_id, SweetAlert, consoleRESTSvc) {
        $scope.req_obj = {
            menu: menu_id
        };
