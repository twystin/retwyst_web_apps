angular.module('consoleApp').controller('CashbackCommissionController', ['$scope', '$modalInstance', 'outlet', 'SweetAlert', 'consoleRESTSvc', '$q',
    function($scope, $modalInstance, outlet, SweetAlert, consoleRESTSvc, $q) {
