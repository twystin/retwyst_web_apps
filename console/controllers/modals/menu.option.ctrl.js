angular.module('consoleApp').controller('MenuOptionController', ['$scope', '$modalInstance', 'option', 'is_new', 'limit_access', 'option_title', 'SweetAlert',
    function($scope, $modalInstance, option, is_new, limit_access, option_title, SweetAlert) {
