angular.module('consoleApp').controller('MenuAddonController', ['$scope', '$modalInstance', 'addon', 'is_new', 'limit_access', 'SweetAlert',
    function($scope, $modalInstance, addon, is_new, limit_access, SweetAlert) {
