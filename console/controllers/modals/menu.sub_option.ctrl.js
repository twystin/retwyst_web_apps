angular.module('consoleApp').controller('MenuSubOptionController', ['$scope', '$modalInstance', 'sub_option', 'is_new', 'limit_access', 'SweetAlert',
    function($scope, $modalInstance, sub_option, is_new, limit_access, SweetAlert) {
