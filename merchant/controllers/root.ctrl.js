angular.module('merchantApp').controller('RootController', ['$scope', '$rootScope', '$state', 'merchantRESTSvc', 'SweetAlert', '$cookies',
        ...
        $scope.logout = function() {
            merchantRESTSvc.logout()
                .then(function(data) {
                    ...
                    $cookies.put('subscribed_outlet', '');
                    $rootScope.isPaying = undefined;
                    $rootScope.token = undefined;
                    $rootScope.subscribed_outlet = '';
                    SweetAlert.swal({
