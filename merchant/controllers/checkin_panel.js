angular.module('merchantApp')
	.controller('CheckinController', ['$scope', '$rootScope', 'merchantRESTSvc', '$stateParams', '$log', 'toastr',
		function($scope, $rootScope, merchantRESTSvc, $stateParams, $log, toastr) {
			...
			$scope.checkinUser = function() {
				...
				if (!$scope.checkin || !$scope.checkin.number) {
					toastr.error("Please fill-in the customer's number", "Error");
