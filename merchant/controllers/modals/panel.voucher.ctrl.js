angular.module('merchantApp').controller('PanelVoucherController', ['$scope', '$modalInstance', 'vouchers', 'outlet', 'SweetAlert', 'merchantRESTSvc', function($scope, $modalInstance, vouchers, outlet, SweetAlert, merchantRESTSvc) {
