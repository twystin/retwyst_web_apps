angular.module('merchantApp').controller('MenuItemController', ['$scope', '$modalInstance', '$modal', 'item', 'is_new', 'limit_access', 'SweetAlert', '$q', function($scope, $modalInstance, $modal, item, is_new, limit_access, SweetAlert, $q) {
