angular.module('merchantApp').controller('MenuSubCategoryController', ['$scope', '$modalInstance', 'sub_category', 'is_new', 'SweetAlert', function($scope, $modalInstance, sub_category, is_new, SweetAlert) {
