angular.module('merchantApp').controller('PickItemController', ['$scope', '$modalInstance', 'merchantRESTSvc', 'SweetAlert', function($scope, $modalInstance, merchantRESTSvc, SweetAlert) {
    $scope.all_menus = [];
